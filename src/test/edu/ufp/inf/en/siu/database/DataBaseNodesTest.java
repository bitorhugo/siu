...
public class DataBaseNodesTest {
    ...
    @Test
    public void removeNodeTest() throws NodeNotFoundException, NodeAlreadyExistsException {
        DataBase db = new DataBase();
        Node n = new Node(1234, new Point(123, 321));
    ...
    @Test
    public void searchNodeTest() throws NodeNotFoundException, NodeAlreadyExistsException {
        DataBase db = new DataBase();
